...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { desc: @bike.desc, name: @bike.name, picurl: @bike.picurl, price: @bike.price, style: @bike.style }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { desc: @bike.desc, name: @bike.name, picurl: @bike.picurl, price: @bike.price, style: @bike.style }
    assert_redirected_to bike_path(assigns(:bike))
  end
